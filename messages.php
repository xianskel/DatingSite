...
?>
    ...
    <body>
        ...
        <div class="container top-marg-msg">
            <div class="row grey">
                <div id="popup">
                ...
                <div class="col-sm-4 contacts">
                    <h3>Conversations</h3>
                    <div id="con-area" class="con-area"></div>
                </div>
                <div class="col-sm-8 nopadding">
                    <div class="msg-container">
                        <div class="header messHead" id="username">
                            <h3>My Messages</h3>
                        </div>
                        <div class="msg-area" id="msg-area"></div>
                        <div class="bottom">
                            <textarea type="text" rows="4" name="text-input" class="text-input" id="text-input" onkeydown="if (event.keyCode==13) sendMsgCallback(this.value)" value="" placeholder="Enter Message Here  (Press Return/Enter to Send)"></textarea>
                        </div>
                    </div>
                </div>
            </div>
